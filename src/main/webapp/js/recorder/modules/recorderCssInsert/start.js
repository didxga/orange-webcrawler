...
var RecorderApp = (function(doc, cons) {
	...
	name : 'proxy',
	url : 'modules/recorder/proxy.js'
    }, */{
	name : 'css',
	url : 'modules/recorder/css.js'
    }, {
	name : 'recorder',
	...
	if (!param.widgetUrl || !param.portletUrl) {
	    console.error('unable to start recorder, missing parameters widgetUrl or portletUrl');
	} else {
	    _loadModules(param);    
	}
    }
